  ...
  <body>
    <form>
      <div class="container mt-3">
        ...
        <br><h3 style="text-align: right;"><b>RM 2.1.14</b></h3>
        ...
        <tbody>
          ...
          <tr>
            <td colspan="3" style="text-align: center;"><h5><b>ASESMEN MEDIS PASIEN BEDAH ORTHOPEDI</b></h5></td>
          </tr>
          ...
          <tr>
            <td>
              ...
              <img src="<?= base_url('img/tulang.png') ?>" alt="logo" width="1000px">
               ...
               <br><br><br><br><div class="mb-3"><label><b>PEMERIKSAAN PENUNJANG </b></label></div>
               <div class="mb-2">
              <div class="col-md-10">
                  <div class="row text-align">
                    <div class="col-md-4">
