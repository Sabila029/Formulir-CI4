  ...
  <body>
    <form>
      <div class="container mt-3">
        ...
        <br><h5 style="text-align: right;"><b>RM 3.2.2</b></h5>
      ...
      <br><h5 style="text-align: center;"><b>DIAGNOSA KETIDAKEFEKTIFAN PERFUSI JARINGAN</b></h5>
          ...
          <tr>
            ...
            <td>
              <div class="mb-1">Perfusi jaringan efdektif, setelah <br> dilakukan tindakan keperawatan <br> selama
                <input type="text" id="v_06" name="v_06" style="width: 50px"> x 24 jam dengan kriteria<br>hasil :</div>
                <div class="form-check">
