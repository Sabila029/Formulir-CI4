    ...
    <form>
      <div class="container mt-3">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="3" style="text-align: center;"><h5><b>ASESMEN AWAL KEPERAWATAN PASIEN NEONATUS RAWAT INAP</b></h5></td>
          </tr>
         ...
         <table class="table table-bordered mb-0" style="border: 1px solid black;">
          ...
          <tr>
            <td>
              <div class="mb-2"><h5><b>3. Pengkajian per system</b></h5></div>
          ...
          <tr>
            <td>
              <div class="mb-2"><h5><b>4.Skrining Nyeri</b></h5></div>
              <div class="row">
                <div class="col-6">
                <div class="mb-2">
           ...
           <tr>
            <td>
              <div class="mb-2"><h5><b>5. Kebutuhan Nutrisi</b></h5></div>
              <div class="row">
                <div class="col-6">
                <div class="mb-2">
          ...
          <tr>
           ...
           <tr>
                <td>
                  <div><h5><b>II.  MASALAH KEPERAWATAN</b></h5></div>
                  <div class="row">
                    <div class="col-6">
              ...
              <tr>
                <td>
                  <div><h5><b>III. PERENCANAAN PEMULANGAN PASIEN / DISCHARGE PLANNING</b></h5></div>
         ...
         <table class="table table-bordered mt-3" style="border: 1px solid black; width: 100%">
          ...
          <br><h7><b>Beri tanda (√) pada kotak () sesuai pilihan <br>Beri tanda (-) untuk isian yang tidak ada keluhan</b></h7>
