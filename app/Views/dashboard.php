...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="Formulir/rumah">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Formulir/input">Formulir</a>        
        <li class="nav-item">
          <a class="nav-link" href="Formulir/data">Data</a>
        </li>
        </li>
      </ul>
    </div>
...
<img src="<?= base_url('img/rs.jpg') ?>" class="card-img-top" width="50px">
        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    <img src="<?= base_url('img/visi.png') ?>" class="card-img-top" width="50px">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    <img src="<?= base_url('img/misi.png') ?>" class="card-img-top" width="50px">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    <img src="<?= base_url('img/motto.png') ?>" class="card-img-top" width="50px">
                    <div class="card-body">
...
<br><br><img src="<?= base_url('img/struktur.jpg') ?>" class="card-img-top" width="30px">

</div>


<br><br><br><br><nav class="navbar navbar-light bg-primary" style="text-align: center;">
