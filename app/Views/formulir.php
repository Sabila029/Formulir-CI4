...
<br><div style="text-align: center;">
    <img src="<?= base_url('img/monitor.png') ?>" alt="logo" width="100px" height="100px" >
  </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    <img src="<?= base_url('img/form.png') ?>" class="card-img-top" width="50px">
                    <div class="card-body">
                        <h5 class="card-title">Pengkajian Awal Keperawatan dan Medis Pasien Neonatus</h5>
                        <br>
                        <a href="satu" class="btn btn-outline-info">Isi Formulir</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <a href="dua" class="btn btn-outline-info">Isi Formulir</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <a href="tiga" class="btn btn-outline-info">Isi Formulir</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <a href="empat" class="btn btn-outline-info">Isi Formulir</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <a href="lima" class="btn btn-outline-info">Isi Formulir</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card mt-5" style="width: 18rem;" align="center">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <a href="enam" class="btn btn-outline-info">Isi Formulir</a>
                    </div>
                </div>
            </div>
